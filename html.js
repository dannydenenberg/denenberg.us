    ...
    return (
      <html lang="en">
        <head>
          ...
          <meta
            property="og:title"
            content="Megan Keesee, Communications Manager"
          />
          <meta
            property="og:image"
            content="https://megankeesee.com/facebook.jpg"
          />
          <meta
            property="og:description"
            content="Megan Keesee is a communications manager based in San Francisco, California."
          />
          <meta
          ...
          <meta
            name="twitter:image"
            content="https://megankeesee.com/twitter.jpg"
          />
        ...
        <body>
          ...
          <script>/* Inject google analytics */</script>
        </body>
      </html>
    );
  }
